...
TODO:
1. Сохранить участников группы в CSV-файл, и при необходимости загружать их из этого CSV-файла;
2. На организации существует два типа сотрудников: с почасовой оплатой, и на постоянной оплате. 
Необходимо расчитать зарплату для отдела сотрудников. (Подумать, и попробовать)
